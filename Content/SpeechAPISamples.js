...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Site,Samples,Set,List,SpeechUtterance,SpeechSynthesis,Client,Builder,T,Operators,Sample,document,Html,Client1,Tags,Operators1,Unchecked,Attr,jQuery,EventsPervasives,Seq,window,Arrays,Utils,Slice,SpeechSynthesisUtterance;
 Runtime.Define(Global,{
  Site:{
   Client:{
   ...
   SpeechSynthesis:{
    Main:function(e)
    {
     var x,info,x1,pre,srecog,arg10,x2,arg00,startBtn,arg101,x3,arg001,arg102,m;
     x=List.ofArray([Tags.Tags().text("Speak loud and clear.")]);
     info=Tags.Tags().NewTag("div",x);
     x1=List.ofArray([Attr.Attr().NewAttr("style","width: 550px; height: 300px; overflow-y: scroll; display: block;")]);
     pre=Tags.Tags().NewTag("pre",x1);
     ...
     srecog.onresult=function(res)
     {
      ...
      },Slice.array(Utils.ToArray(res.results),{
       $:1,
       $0:res.resultIndex
      },{
       $:0
     ...
     arg10=List.ofArray([Tags.Tags().text("Start")]);
     x2=Tags.Tags().NewTag("button",arg10);
     arg00=function()
     {
      return function()
      {
     ...
     EventsPervasives.Events().OnClick(arg00,x2);
     startBtn=x2;
     arg101=List.ofArray([Tags.Tags().text("Stop")]);
     x3=Tags.Tags().NewTag("button",arg101);
     arg001=function()
     {
      return function()
      {
     ...
     EventsPervasives.Events().OnClick(arg001,x3);
     arg102=List.ofArray([info,pre,startBtn,x3]);
     m=Tags.Tags().NewTag("div",arg102);
     return jQuery(e).append(m.Dom);
    },
   ...
   SpeechUtterance:{
    ...
    {
     var arg10,m;
     arg10=SpeechUtterance.MkField(window.speechSynthesis,new SpeechSynthesisUtterance());
     m=Tags.Tags().NewTag("div",arg10);
     return jQuery(e).append(m.Dom);
    },
    MkField:function(sp,u)
    {
     ...
     {
      var text,lang,x1,t,arg10,x2,arg00,b,arg101;
      text=elem[0];
      lang=elem[1];
      x1=List.ofArray([Attr.Attr().NewAttr("width","200"),Tags.Tags().text(text)]);
      t=Tags.Tags().NewTag("textarea",x1);
      arg10=List.ofArray([Tags.Tags().text("Speak!")]);
      x2=Tags.Tags().NewTag("button",arg10);
      arg00=function()
      {
       return function()
      ...
      EventsPervasives.Events().OnClick(arg00,x2);
      b=x2;
      arg101=List.ofArray([Attr.Attr().NewAttr("style","margin: 5px; display: inline-block;")]);
      return Operators1.add(Tags.Tags().NewTag("div",arg101),List.ofArray([t,Tags.Tags().NewTag("br",Runtime.New(T,{
       $:0
      })),b]));
     },x);
    },
