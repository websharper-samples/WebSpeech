...
{
 "use strict";
 var Global,Site,Client,Samples,Set,WebSharper,JavaScript,JS,Sample,Operators,Obj,UI,HtmlModule,attr,List,Doc,SC$1,T,EventTarget,WindowOrWorkerGlobalScope,Node,Unchecked,AttrProxy,Pervasives,AttrModule,Array,Client$1,Templates,SpeechUtterance,SpeechSynthesis,Attrs,DomUtility,View,Arrays,Object,Collections,Dictionary,Seq,SC$2,SC$3,Docs,Snap,DocElemNode,CharacterData,Enumerator,SC$4,HashSet,SC$5,Builder,T$1,An,Settings,Abbrev,Mailbox,Elt,Attrs$1,Dyn,DictionaryUtil,Prepare,Slice,KeyCollection,Var$1,Var,Event,Utils,Docs$1,RunState,NodeSet,Anims,SC$6,Updates,Strings,ConcreteVar,Fresh,SC$7,Concurrency,AppendList,SC$8,HashSetUtil,Easing,AsyncBody,SC$9,CT,HashSet$1,Queue,SC$10,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$11,LazyExtensionsProxy,LazyRecord,DynamicAttrNode,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 Doc=UI.Doc=UI.Doc||{};
 SC$1=Global.StartupCode$SpeechAPISamples$Client=Global.StartupCode$SpeechAPISamples$Client||{};
 T=List.T=List.T||{};
 ...
 SpeechUtterance=Site.SpeechUtterance=Site.SpeechUtterance||{};
 SpeechSynthesis=Site.SpeechSynthesis=Site.SpeechSynthesis||{};
 ...
 SC$2=Global.StartupCode$SpeechAPISamples$SpeechUtterance=Global.StartupCode$SpeechAPISamples$SpeechUtterance||{};
 SC$3=Global.StartupCode$SpeechAPISamples$SpeechSynthesis=Global.StartupCode$SpeechAPISamples$SpeechSynthesis||{};
 ...
 Var=UI.Var=UI.Var||{};
 Event=Global.Event;
 Utils=SpeechSynthesis.Utils=SpeechSynthesis.Utils||{};
 ...
 Set=Samples.Set=Runtime.Class({
  Show:function()
  {
   ...
   return Global.jQuery(function()
   {
    ...
    return Doc.RunById("sample-navs",a);
   });
  }
 },null,Set);
 ...
 Sample=Samples.Sample=Runtime.Class({
  Show:function()
  {
   ...
   })],[]),Doc.Element("a",[AttrProxy.Create("class","btn btn-primary btn-lg"),AttrProxy.Create("href","http://github.com/intellifactory/websharper.webspeech/blob/master/Site/"+this.FileName)],[Doc.TextNode("Source")])]);
   Templates.LoadLocalTemplates("");
   Doc.Run(sSide,a);
  }
 },null,Sample);
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.All=Set.Create([Set.Singleton(SpeechUtterance.Sample()),Set.Singleton(SpeechSynthesis.Sample())]);
 };
 ...
 SpeechUtterance.Sample=function()
 {
  SC$2.$cctor();
  return SC$2.Sample;
 };
 SpeechUtterance.Main=function(e)
 {
  var a;
  a=Doc.Element("div",T.Empty,SpeechUtterance.MkField(Global.speechSynthesis,new Global.SpeechSynthesisUtterance()));
  Templates.LoadLocalTemplates("");
  Doc.Run(e,a);
 };
 SpeechUtterance.MkField=function(sp,u)
 {
  function m(txt,lang)
  {
   var txt$1,t,b;
   txt$1=Var$1.Create$1(txt);
   t=Doc.InputArea([AttrProxy.Create("width","200")],txt$1);
   b=Doc.Element("button",[AttrModule.Handler("click",function()
   {
    return function()
    {
     u.text=txt$1.Get();
   ...
   return Doc.Element("div",[AttrProxy.Create("style","margin: 5px; display: inline-block;")],[t,Doc.Element("br",[],[]),b]);
  }
 ...
 SpeechUtterance.Texts=function()
 {
  SC$2.$cctor();
  return SC$2.Texts;
 };
 SpeechSynthesis.Sample=function()
 {
  SC$3.$cctor();
  return SC$3.Sample;
 };
 SpeechSynthesis.Main=function(e)
 {
  var txt,info,pre,srecog,r,a;
  txt=Var$1.Create$1("");
  info=Doc.Element("div",[],[Doc.TextNode("Speak loud and clear.")]);
  pre=Doc.Element("pre",[AttrProxy.Create("style","width: 550px; height: 300px; overflow-y: scroll; display: block;")],[Doc.TextView(txt.get_View())]);
  srecog=(r=new(Global.SpeecRecognition||Global.webkitSpeechRecognition)(),r.lang="en-US",r.continuous=true,r.onresult=function(res)
  {
   var a$1;
   Arrays.iter(function(e$1)
   {
    txt.Set(txt.Get()+e$1.transcript);
   },(a$1=Arrays.map(Utils.ToArray,Slice.array(Utils.ToArray(res.results),{
    $:1,
    $0:res.resultIndex
   },null)),Arrays.map(SpeechSynthesis.MaxConfidence(),a$1)));
   pre.elt.scrollTop=pre.elt.scrollHeight;
  },r);
  a=Doc.Element("div",[],[info,pre,Doc.Element("button",[AttrModule.Handler("click",function()
  {
   return function()
   {
    return srecog.start();
   };
  })],[Doc.TextNode("Start")]),Doc.Element("button",[AttrModule.Handler("click",function()
  {
   return function()
   {
    return srecog.stop();
 ...
 SpeechSynthesis.MaxConfidence=function()
 {
  SC$3.$cctor();
  return SC$3.MaxConfidence;
 };
 ...
 SC$2.$cctor=function()
 {
  ...
  SC$2.Texts=List.ofArray([["Hey! How are you doing?","en-US"],["Hey! How are you doing?","en-GB"],["Hallo! Wie geht's?","de-DE"],["Ciao! Come và?","it-IT"],["\u3053\u3093\u306b\u3061\u306f\u304a\u5143\u6c17\u3067\u3059\u304b","ja-JP"]]);
  SC$2.Sample=Samples.Build().Id("SpeechUtterance").FileName("SpeechUtterance.fs").Keywords(List.ofArray(["user media","speech utterance","speech","TTS"])).Render(function(e)
  {
   SpeechUtterance.Main(e);
  }).Create();
 };
 SC$3.$cctor=function()
 {
  ...
  SC$3.MaxConfidence=function(a)
  {
   return Arrays.maxBy(p,a);
  };
  SC$3.Sample=Samples.Build().Id("SpeechSynthesis").FileName("SpeechSynthesis.fs").Keywords(List.ofArray(["user media","speech synthesis","speech","speech-to-text"])).Render(function(e)
  {
   SpeechSynthesis.Main(e);
  }).Create();
 };
 ...
 {
  return Arrays.ofList(function(n,acc)
  {
   var n$1;
   while(true)
    if(n===-1)
