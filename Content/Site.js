...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Site,Samples,Set,WebSharper,List,SpeechUtterance,SpeechSynthesis,Client,Builder,T,Operators,Sample,document,Html,Client1,Default,Operators1,Unchecked,jQuery,EventsPervasives,Seq,window,Arrays,Utils,OperatorIntrinsics,SpeechSynthesisUtterance;
 Runtime.Define(Global,{
  Site:{
   Client:{
   ...
   SpeechSynthesis:{
    Main:function(e)
    {
     var info,pre,_this,srecog,x,x1,startBtn,x2,x3,m;
     info=Default.Div(List.ofArray([Default.Text("Speak loud and clear.")]));
     _this=Default.Attr();
     pre=Default.Pre(List.ofArray([_this.NewAttr("style","width: 550px; height: 300px; overflow-y: scroll; display: block;")]));
     ...
     startBtn=x;
     x2=Default.Button(List.ofArray([Default.Text("Stop")]));
     x3=function()
     {
      return function()
      {
     ...
     m=Default.Div(List.ofArray([info,pre,startBtn,x2]));
    ...
    Utils:{
     ToArray:function(a)
     {
      ...
      list=helper(a.length-1,Runtime.New(T,{
       $:0
      }));
   ...
   SpeechUtterance:{
    ...
    MkField:function(sp,u)
    {
     ...
     {
      var text,lang,t,_this,x1,x2,b,_this1,_this2,x3;
      text=elem[0];
      lang=elem[1];
      _this=Default.Attr();
      t=Default.TextArea(List.ofArray([_this.NewAttr("width","200"),Default.Text(text)]));
      ...
      return Operators1.add(Default.Div(List.ofArray([_this1.NewAttr("style","margin: 5px; display: inline-block;")])),List.ofArray([t,_this2.NewTag("br",x3),b]));
     }),x);
    },
    Sample:Runtime.Field(function()
    {
