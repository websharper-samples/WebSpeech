...
declare module Site {
    ...
    module SpeechSynthesis {
        module Utils {
            var ToArray : {
                <_M1>(a: __ABBREV.__JavaScript.ArrayLike<_M1>): _M1[];
            };
        }
        var Main : {
        ...
        var MaxConfidence : {
            (): {
                (x: __ABBREV.__JavaScript.SpeechRecognitionAlternative[]): __ABBREV.__JavaScript.SpeechRecognitionAlternative;
            };
        };
        var Sample : {
    ...
    module SpeechUtterance {
        var MkField : {
            (sp: __ABBREV.__JavaScript.SpeechSynthesis, u: __ABBREV.__JavaScript.SpeechSynthesisUtterance): __ABBREV.__List.T<__ABBREV.__Client.Element>;
        };
        var Main : {
            (e: __ABBREV.__Dom.Element): void;
        };
